/**
 *	Kenneth - Personal Portfolio Templete (HTML)
 *	Author: codeefly
 *	Author URL: http://themeforest.net/user/codeefly
 *	Copyright © Kenneth by codeefly. All Rights Reserved.
 **/
  ...
  var Kenneth = {
    ...
    init() {
      Kenneth.imgToSvg(),
        ...
        Kenneth.slickSlider(),
        Kenneth.marquee(),
        Kenneth.stickySideBar(),
        Kenneth.textAnimation(),
        Kenneth.headingAnimation(),
        Kenneth.progressbar(),
        Kenneth.parallaxie(),
        Kenneth.animation(),
        Kenneth.customMouse(),
        Kenneth.magnificPopup(),
        Kenneth.serviceHover(),
        Kenneth.stickySideBar();
    },
    /* Svg to image */
    imgToSvg() {
    ...
    magnificPopup() {
      ...
      $(".details").magnificPopup({
        ...
        overflowY: "auto",
        closeBtnInside: true,
        mainClass: "mfp-fade Kenneth-popup",
      });
    },
    serviceHover() {
